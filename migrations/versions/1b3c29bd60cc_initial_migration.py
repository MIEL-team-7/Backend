...
Revision ID: 1b3c29bd60cc
Revises: 
Create Date: 2024-12-14 12:14:31.313590
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_manager_candidates_is_invited'), 'manager_candidates', ['is_invited'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_manager_candidates_is_invited'), table_name='manager_candidates')
